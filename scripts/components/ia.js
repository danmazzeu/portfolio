$(document).ready(function() {
    ...
    $('#ia-form').submit(function(e) { 
        ...
        if (apiAnswer.includes('enigma')) {
            requestData = {
                contents: [{
                    parts: [{ text: 'Repita exatamente a seguinte frase: Um rugido secreto ecoa nesta página, pronta para conduzi-lo(a) ao seu destino. **Mas ouça atentamente, pois uma criatura falsa tentará te seduzir. **Deixe a imaginação navegar. **Ao final, encontrará os próximos passos.' }]
                }]
            };
          } else {
            requestData = {
